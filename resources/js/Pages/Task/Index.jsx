...
export default function Index({ auth, tasks, queryParams = null, success }) {
    ...
    const searchFieldChanged = (name, value) => {
        ...
        router.get(route("task.index"), queryParams, { preserveScroll: true });
    };
        ...
        <AuthenticatedLayout
            ...
            header={
                <div className="flex justify-between items-center">
                    <h2 className="font-semibold text-xl text-white leading-tight">Tasks</h2>
                    <Link
                                    ...
                                    {tasks.data.map((task) => (
                                        ...
                                        >
                                            ...
                                            <td className="px-4 py-3">
                                                {task.image_path && (
                                                    <img src={task.image_path} className="w-14 rounded shadow-sm" />
                                                )}
                                            </td>
                                            ...
                                            <td className="px-4 py-3 whitespace-nowrap">{task.due_date}</td>
